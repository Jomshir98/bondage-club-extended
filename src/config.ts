...
export const FUNCTION_HASHES: Record<string, string[]> = {
	...
	BackgroundSelectionRun: ["DB865494", "698CEE29"],
	...
	ChatCreateClick: ["765AEBFE", "E01A5C84"],
	...
	ChatRoomMessage: ["2C6E4EC3", "4340BC41", "6026A4B6", "E3EE1C77", "58EAAE61", "60ECCB9B", "4E97FAA5", "434FF2E9", "29F6DE79", "3041CEA5", "D355B2C4", "48A4F3CC", "F9414B8C"],

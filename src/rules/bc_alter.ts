		...
		load(state) {
			...
			hookFunction("ChatAdminRun", 0, (args, next) => {
				...
				if (state.isEnforced && ChatRoomPlayerIsAdmin() && Player.IsRestrained()) {
					...
					DrawButton(1426, 728, 64, 64, "", "#ebebe4", ChatAdminData!.Private ? "Icons/Checked.png" : "", "", true);
					DrawButton(1756, 728, 64, 64, "", "#ebebe4", ChatAdminData!.Locked ? "Icons/Checked.png" : "", "", true);

...
export const FUNCTION_HASHES: Record<string, string[]> = {
	...
	ChatCreateRun: ["B0A3D236", "8B2AF873"],
	...
	ChatRoomClickCharacter: ["21AEE568", "AA9259DF", "AD490A80"],
	...
	ChatRoomMessage: ["2C6E4EC3", "4340BC41", "6026A4B6", "E3EE1C77", "58EAAE61", "60ECCB9B", "4E97FAA5", "434FF2E9", "29F6DE79", "3041CEA5", "D355B2C4", "48A4F3CC"],
	...
	CommandParse: ["12DC018B", "534545CD"],
